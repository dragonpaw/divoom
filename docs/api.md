...
| Field      | Type   | Notes |
|------------|--------|-------|
| `ID`       | number | >0. Re-sending the same ID overwrites the previous element with that ID. |
...
- **Roboto Condensed verified 2026-05-21** at FontID 9, FontSize 80. Same procedure applied without modification.
